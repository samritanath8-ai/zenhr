...
export default function ForgotPassword({ status }: { status?: string }) {
    ...
    return (
        <>
            <Head title="Forgot Password — ZenHR" />
            <style>{`
                ...
                *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .card-sub { font-size: 14px; color: rgba(255,255,255,0.4); margin-bottom: 28px; line-height: 1.6; }
                ...
                .btn { width: 100%; background: #f5c842; color: #080b14; border: none; border-radius: 12px; padding: 14px; font-size: 15px; font-weight: 700; font-family: 'DM Sans', sans-serif; cursor: pointer; transition: all 0.2s; margin-top: 20px; box-shadow: 0 4px 24px rgba(245,200,66,0.25); }
                ...
                <div className="wrap">
                    ...
                    <div className="card">
                        ...
                        <form onSubmit={submit}>
                            ...
                            <input className="field-input" type="email" placeholder="you@example.com" value={data.email} onChange={e => setData('email', e.target.value)} required autoFocus />
